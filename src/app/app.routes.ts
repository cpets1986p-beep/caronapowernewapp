...
import { Overview} from './overview-hv-engineering/overview-hv-engineering';
...
export const routes: Routes = [ 
    ...
    { path: 'home-hv-engineering', component: Home },
    { path:'overview-hv-engineering',component:Overview},
    ...
    { path: '', redirectTo: '/home-hv-engineering', pathMatch: 'full' },
